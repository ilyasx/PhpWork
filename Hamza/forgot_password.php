...
if(isset($_POST['send_my_password'])){
    ...
    if($row = $result->fetch_assoc()){
        ...
        if(mail($email,'Your Password',"Your Password is: $password","From: hamzasaleem610@gmail.com")){
        ...
        header("Location:forgot_password.php?err=" . urlencode("Sorry their is no User with this Email"));
            exit();
