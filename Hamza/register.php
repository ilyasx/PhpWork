...
if(isset($_POST['register'])){
    ...
    if(strlen($_POST['name']) < 3){
        header("Location:register.php?err=" . urlencode("The name must be atleast 3 character long"));
        exit();
    }
    ...
    header("Location:register.php?err=" . urlencode("the password and confirm password do not match"));
        ...
        header("Location:register.php?err=" . urlencode("The password should be atleast five characters"));
        exit();
    }
    else if(strlen($_POST['confirm_password'])<5){
        header("Location:register.php?err=" . urlencode("The confirm password should be atleast five characters"));
        exit();
    }
        ...
        $db->query($query);
        $message = "Hi $name: Account created here is the activation link http://localhost/registration/activate.php?$token";
        
        mail('$email','Activate Account',$message,'From: hamzasaleem610@gmail.com');
